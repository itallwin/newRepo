...
CREATE TABLE dbo.TblMstTSKTenant (
    TenantUno            BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE dbo.TblMstTSKUser (
    UserUo                  BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    TenantUno                BIGINT NOT NULL,
...
CREATE TABLE dbo.TblMstTSKProject (
    ...
    DepartmentId         BIGINT NULL,
    ProjectManagerUserUo BIGINT NULL,
...
CREATE TABLE dbo.TblTrnTSKTask (
    TaskUno                BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    TenantUno              BIGINT NOT NULL,
    ...
    ParentTaskUno          BIGINT NULL,
    RequestedByUserUo     BIGINT NULL,
    OwnerUserUo           BIGINT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskAssignment (
    ...
    TenantUno              BIGINT NOT NULL,
    TaskUno                BIGINT NOT NULL,
    AssigneeUserUo        BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskComment (
    ...
    TenantUno              BIGINT NOT NULL,
    TaskUno                BIGINT NOT NULL,
    ParentTaskCommentId   BIGINT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskCommentDraft (
    TaskCommentDraftId    BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    TenantUno              BIGINT NOT NULL,
    TaskUno                BIGINT NOT NULL,
    UserUo                BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskCommentMention (
    TaskCommentMentionId  BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    TenantUno              BIGINT NOT NULL,
    TaskCommentId         BIGINT NOT NULL,
    MentionedUserUo       BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskHistory (
    TaskHistoryId          BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    TenantUno               BIGINT NOT NULL,
    TaskUno                 BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskDependency (
    ...
    TenantUno              BIGINT NOT NULL,
    TaskUno                BIGINT NOT NULL,
    DependsOnTaskUno       BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskApproval (
    ...
    TenantUno              BIGINT NOT NULL,
    TaskUno                BIGINT NOT NULL,
    ApproverUserUo        BIGINT NOT NULL,
...
CREATE TABLE dbo.TblTrnTSKTaskReassignment (
    ...
    TenantUno               BIGINT NOT NULL,
    TaskUno                 BIGINT NOT NULL,
    FromAssigneeUserUo     BIGINT NULL,
    ToAssigneeUserUo       BIGINT NOT NULL,
    ...
    ReassignedByUserUo     BIGINT NULL,
...
CREATE TABLE dbo.TblTrnTSKActivityFeed (
    ...
    ActorUserUo            BIGINT NULL,
    TargetUserUo           BIGINT NULL,
